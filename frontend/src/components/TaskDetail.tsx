...
export const TaskDetail: React.FC<TaskDetailProps> = ({ isOpen, onClose, task }) => {
      ...
      >
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="flex flex-col space-y-3 sm:space-y-4 max-h-[60vh] sm:max-h-none overflow-y-auto sm:overflow-visible pr-1 sm:pr-2">
            ...
            {/* Posted by */}
            <div className="flex items-center space-x-3 sm:space-x-4 bg-[#171717] rounded-xl p-3 sm:p-4 border-[0.5px] border-[#707070]">
            ...
            {/* Açıklama */}
            <div className="flex items-start space-x-3 sm:space-x-4 bg-[#171717] rounded-xl p-3 sm:p-4  border-[0.5px] border-[#707070]">
        ...
        <div className="w-full mt-2 sm:mt-4 border-t-[0.5px] border-[#707070] pt-3 sm:pt-4 bg-[#171717] flex justify-center items-center p-3 sm:p-4">
          <button
            ...
            onClick={() => console.log('Task claimed: ', task.taskId)}
          >
            <span className="text-white font-normal text-sm sm:text-base tracking-wide">CLAIM TASK</span>
          </button>
        </div>
      </div>
    </div>
